...
function App() {
  ...
  }, [handleKeyDown, handleKeyUp, handleMouseDown, handleMouseUp, handleMouseMove, handlePointerLockChange, isDesignMode]);
  ...
  useEffect(() => {
    if (isDesignMode) {
      ...
      console.log("Not in design mode and connected - setting up input listeners");
      setupInputListeners();
      setupDelegatedListeners();
    }
  }, [isDesignMode, connected, setupInputListeners, removeInputListeners, setupDelegatedListeners, removeDelegatedListeners]);
  ...
  return (
    <div className="App" style={{ width: '100vw', height: '100vh', position: 'relative' }}>
      {showJoinDialog && !isDesignMode && <JoinGameDialog onJoin={handleJoinGame} />}
      ...
      {(connected || isDesignMode) && (
        <>
          ...
          {localPlayer && !isDesignMode && <PlayerUI playerData={localPlayer} />} 
        </>
      )}
